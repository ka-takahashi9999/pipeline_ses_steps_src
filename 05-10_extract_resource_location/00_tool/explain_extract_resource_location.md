# explain_extract_resource_location
...
- `05-10_extract_resource_location/00_tool/location_dictionary.txt`

## 出力ファイルと構造
- `extract_resource_location.jsonl`
- `99_location_null_extract_resource_location.jsonl`
